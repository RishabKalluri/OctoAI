...
import RelevantUpdates from '../components/RelevantUpdates'
    ...
    <div className="min-h-full">
      ...
      <div className="p-8">
        <div className="flex gap-8">
          ...
          {/* Right Panel - Relevant to You */}
          <div className="w-96 flex-shrink-0">
            <Card className="p-5 sticky top-28" delay={0.3}>
              <div className="flex items-center gap-3 mb-4">
                <div className="w-9 h-9 rounded-lg bg-gradient-to-br from-rose-500 to-amber-500 flex items-center justify-center">
                  <Bell className="w-4 h-4 text-white" />
                </div>
                <div>
                  <h3 className="font-semibold text-octo-gray-900">Relevant to You</h3>
                  <p className="text-[10px] text-octo-gray-500">Updates that may affect your work</p>
                </div>
                <span className="ml-auto px-2 py-0.5 rounded-full text-xs font-medium bg-rose-100 text-rose-700">
                  3 new
                </span>
              </div>
              ...
              <div className="mt-4 pt-4 border-t border-octo-gray-100">
                <p className="text-[10px] text-octo-gray-400 flex items-center gap-1">
                  <Sparkles className="w-2.5 h-2.5" />
                  Octo monitors changes relevant to your recent work
                </p>
              </div>
            </Card>
          </div>
